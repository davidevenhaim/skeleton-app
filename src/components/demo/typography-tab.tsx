...
const LOTTIEFILES_FREE_ANIMATIONS_URL =
      ...
      <Card className='overflow-hidden'>
        ...
        <CardContent className='space-y-10 pt-8'>
          <section className='space-y-4'>
            ...
            <div className='space-y-0 divide-y divide-border/60 rounded-xl border border-border/60 bg-muted/10 p-4 md:p-5'>
          ...
          <section className='space-y-4'>
            ...
            <div className='grid gap-8 lg:grid-cols-2 lg:items-stretch'>
              <div className='flex h-full min-h-0 flex-col gap-3'>
                ...
                <div className='flex min-h-0 flex-1 flex-col gap-3 rounded-xl border border-border/60 bg-background p-4'>
              ...
              <div className='grid gap-6 md:grid-cols-2'>
                <div className='flex flex-col gap-3 rounded-xl border border-border/60 bg-background p-4'>
                  ...
                  <div className='flex flex-1 flex-col items-center justify-center gap-4 py-4'>
                    <AnimatedDivBreathing className='flex size-28 items-center justify-center rounded-2xl bg-primary/15 text-primary shadow-sm ring-1 ring-primary/20'>
                      <Iconify
                  ...
                  <CarouselContent>
                    {(["slide1", "slide2", "slide3"] as const).map((key) => (
                      <CarouselItem key={key}>
                        <div className='flex aspect-video items-center justify-center rounded-xl border bg-muted/40 p-6'>
                          <Typography
                            variant='subtitle2'
                            as='p'
                            className='text-foreground'
            ...
            <div className='space-y-3'>
              ...
              <ContextMenu>
                <ContextMenuTrigger asChild>
                  <button
                    type='button'
                    className='flex w-full max-w-md items-center justify-center rounded-xl border border-dashed border-border bg-muted/20 px-4 py-10 text-center outline-none'
                  >
            ...
            <div className='space-y-3'>
              ...
              <div className='flex flex-wrap items-center gap-3 rounded-xl border border-border/60 bg-background p-4'>
            ...
            <div className='space-y-3'>
              ...
              <div className='flex flex-wrap gap-2 rounded-xl border border-border/60 bg-background p-4'>
                <Badge>{t("showcase.badgeDefault")}</Badge>
                <Badge variant='secondary'>
                  {t("showcase.badgeSecondary")}
                </Badge>
                <Badge variant='outline'>{t("showcase.badgeOutline")}</Badge>
                <Badge variant='success-light'>
                  {t("showcase.badgeSuccess")}
                </Badge>
              </div>
            </div>
            ...
            <div className='space-y-3'>
              ...
              <div className='rounded-xl border border-border/60 bg-background p-4'>
                <Tabs defaultValue='view-a' className='w-full'>
                  <TabsList
                    variant='line'
                    className='mb-4 w-full max-w-lg justify-start'
                  >
            ...
            <div className='space-y-3'>
              ...
              <div className='grid gap-4 md:grid-cols-3'>
                <Accordion
                  type='single'
                  collapsible
                  className='w-full rounded-xl border border-border/60 bg-background px-3'
                >
            ...
            <div className='space-y-3'>
              ...
              <div className='w-full max-w-5xl rounded-xl border border-border/60 bg-background p-4'>
...
function ViewResizableScrollSeparatorDemo() {
  ...
  return (
    <ResizablePanelGroup
      ...
      className={cn(
        "w-full rounded-lg border bg-muted/10",
        orientation === "horizontal"
          ? "h-[min(220px,35vh)] min-h-[200px]"
          : "min-h-[420px]"
      )}
    >
      <ResizablePanel
...
function ViewSkeletonToggle({
  tDemo
}: {
  tDemo: ReturnType<typeof useTranslations<"demo">>;
}) {
  const add = useLoaderStore((state) => state.add);
  const remove = useLoaderStore((state) => state.remove);
  const isOn = useLoaderStore(
    (state) => (state.keys["__demo_skeleton__"] ?? 0) > 0
  );
