                ...
                <Table containerClassName='rounded-lg border border-border/60 bg-background/50'>
                  <TableHeader>
                    <TableRow className='hover:bg-transparent'>
                      <TableHead className='w-[9rem] min-w-[7rem]'>
                        {t("columnAgent")}
                      </TableHead>
                    ...
                    {CAVEMAN_INSTALL_ROWS.map((row) => {
                      ...
                      return (
                        <TableRow key={row.id}>
                          ...
                          >
                            <code className='text-xs leading-relaxed text-foreground'>
                              {row.command}
                            </code>
                          </TableCell>
                    ...
                    <div className='mt-4 space-y-4'>
                      ...
                      <div>
                        ...
                        <ul className='space-y-2'>
                          {examples.map((line, i) => (
                            <li key={`${tipId}-ex-${i}`}>
                              <code className='block rounded-md border border-border/60 bg-background/50 px-2.5 py-1.5 text-xs leading-relaxed text-foreground'>
                                {line}
                              </code>
                            </li>
                          ))}
