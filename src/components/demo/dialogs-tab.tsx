    ...
    <TabsContent value='dialogs' className='space-y-6'>
      <Card>
        ...
        <CardContent className='flex flex-wrap gap-2'>
          <AppDialog
            trigger={
              <Button variant='outline'>{tDemo("dialogs.openDialog")}</Button>
            }
          ...
          <AppDialog
            trigger={
              <Button variant='outline'>{tDemo("dialogs.nestedDialog")}</Button>
            }
            title={tDemo("dialogs.welcome")}
            description={tDemo("dialogs.reusableDialog")}
            size='sm'
          >
            <Typography variant='caption2' className='text-sm text-foreground'>
      ...
      <div className='grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3'>
        ...
        <Card className='sm:col-span-2 lg:col-span-1'>
          ...
          <CardContent className='text-sm text-muted-foreground'>
            ...
            <code className='rounded bg-muted px-1 text-xs'>layout.tsx</code>.
          </CardContent>
        </Card>
      </div>
    </TabsContent>
