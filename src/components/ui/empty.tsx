...
function Empty({
  ...
  return (
    <div
      data-slot="empty"
      className={cn(
        "relative overflow-hidden rounded-3xl border border-dashed border-slate-300/80 bg-gradient-to-br from-background via-background to-slate-50/80 p-8 shadow-sm dark:border-slate-700 dark:to-slate-900/60",
        className
      )}
      {...props}
    />
  ...
  return (
    <div
      ...
      className={cn(
        ...
        variant === "icon" ? "size-16 text-primary" : "min-h-16 min-w-16 p-3",
        className
      )}
      {...props}
    />
